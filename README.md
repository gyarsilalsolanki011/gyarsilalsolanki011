...
1. **EliteConnect - Matrimony Application**
   A full-stack matrimonial application developed with **Spring Boot, Java, MySQL, JWT, Hibernate (JPA)** backend and collaborated on a **React, TypeScript, Vite** frontend.  
